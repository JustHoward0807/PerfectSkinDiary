...
export default function PhotoFullscreenAndroid({
    ...
    <Modal visible={visible} transparent animationType="fade" statusBarTranslucent>
      <View style={[styles.root, { width: screenWidth, height: screenHeight }]}>
        ...
        <View style={StyleSheet.absoluteFill} pointerEvents="box-none">
          <View style={[styles.scoreBadge, { bottom: bottom + 20 }]} pointerEvents="none">
          ...
          <Pressable
            ...
            onPress={onClose}
            hitSlop={12}
            android_ripple={{ color: 'rgba(255,255,255,0.2)', radius: 20, borderless: true }}
          >
...
const styles = StyleSheet.create({
  ...
  closeBtnInner: {
    width: 40, height: 40, backgroundColor: 'rgba(0,0,0,0.55)',
  ...
  handle:   { width: 36, height: 4, borderRadius: 2, backgroundColor: Colors.outline, alignSelf: 'center', marginTop: 10, marginBottom: 14 },
  panelHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16, paddingBottom: 12 },
  panelTitle:  { fontSize: 11, fontWeight: '600', color: Colors.onSurfaceVariant, letterSpacing: 1 },
  clearText:   { fontSize: 13, color: Colors.primary },
  panelScroll: { flex: 1 },
  panelScrollContent: { paddingHorizontal: 16, paddingBottom: 24 },
  chipGrid:  { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  chip:      { minHeight: 44, paddingHorizontal: 8, paddingVertical: 8, borderRadius: Radius.sm, backgroundColor: Colors.outline, alignItems: 'center', justifyContent: 'center', gap: 3, overflow: 'hidden' },
  chipSelected:     { backgroundColor: Colors.primary },
  chipText:         { fontSize: 11, fontWeight: '500', color: Colors.onSurface, textAlign: 'center' },
